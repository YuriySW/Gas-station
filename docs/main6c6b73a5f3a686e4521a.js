...
/* harmony export */   PassangerCar: () => (/* binding */ PassangerCar),
...
class PassangerCar extends Car {
  typeCar = 'passanger';
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   RenderStation: () => (/* binding */ RenderStation)
/* harmony export */ });
class RenderStation {
  ...
  createColumns() {
    ...
    this.station.filling.forEach(column => {
      ...
      columnName.textContent = `${column.type} (${column.speed}л/с)`;
      columnName.style.fontWeight = 'bold';
      columnName.style.marginBottom = '10px';
...
/* harmony export */ });
/* harmony import */ var _column__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./column */ "./src/modules/column.js");
/* harmony import */ var _renderStation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renderStation */ "./src/modules/renderStation.js");
...
class Station {
  ...
  #addColumnGroup(optionStation) {
    ...
    for (let i = 0; i < count; i++) {
      this.#filling.push(new _column__WEBPACK_IMPORTED_MODULE_0__.Column(optionStation.type, speed));
    }
  }
  #initRender() {
    if (this.renderApp) {
      this.renderStation = new _renderStation__WEBPACK_IMPORTED_MODULE_1__.RenderStation(this.renderApp, this);
    }
  }
  #startIntervals() {
    setInterval(() => {
...
/* harmony import */ var _modules_car__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/car */ "./src/modules/car.js");
/* harmony import */ var _modules_station__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/station */ "./src/modules/station.js");
...
const testArray = {
  passangerCar: [['Opel', 'Crossland', 45], ['Opel', 'Grandland X', 53], ['Mazda', 'cx-5', 55], ['BMW', 'M5', 68], ['BMW', 'X5', 80], ['BMW', 'X5d', 80, 'diesel'], ['BMW', 'X3', 65], ['BMW', '5', 66], ['Toyota', 'Camry', 60, 'gaz'], ['Volkswagen', 'Golf', 50, 'gaz']],
...
const getTestCar = () => {
  ...
  return typeBool ? new _modules_car__WEBPACK_IMPORTED_MODULE_1__.PassangerCar(...randomCar) : new _modules_car__WEBPACK_IMPORTED_MODULE_1__.Truck(...randomCar);
};
const station = new _modules_station__WEBPACK_IMPORTED_MODULE_2__.Station([{
  type: 'petrol',
  count: 2,
  speed: 5
}, {
...
/******/ })()
;
//# sourceMappingURL=main6c6b73a5f3a686e4521a.js.map